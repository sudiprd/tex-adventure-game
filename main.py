...
def intro():
    ...
    print()
    print()
    print("The rock released a boulder that was blocking the cave entrances.")
    time.sleep(a)
    print("Three paths are revealed:")
    time.sleep(a)
    print()
    print("Path #1: Exist forward through the caves entrances, into the light.")
    time.sleep(a)
...
def path3():
    print("You climn down the vines into a bottomless hole in the ground.")
    time.sleep(a)
    print("It's a dark, damp, and hard to climb down the views, but your vision and muscles eventually adjust.")
    time.sleep(a)
    print("A huge boulder slides into the place above you, blocking your escape.")
    time.sleep(a)
    print("You continue climbing down the vines untill you hear something whirring up at you.")
    time.sleep(a)
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 ="... My name is SHINIGAMI.... I will be your guide to freedom."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    for character in s4:
        ...
        time.sleep(b)
    print()
    s5 = "... I am on my way to deliver a message, so I can rescort your personale..."
    for character in s5:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    for character in s7:
        ...
        time.sleep(b)
    print()
    print("SHINIGAMI will transport you anywhere on Mount OLYMPUS:")
    time.sleep(a)
    print("Path #1: Continue below to face CHRONOS.")
    time.sleep(a)
    print("Path #2: Read: THE SECRET OF TIME.")
    time.sleep(a)
    print("Path #3: Speak with ARES.")
    time.sleep(a)
    print("Path #4: Speak with ARIENS.")
    time.sleep(a)
    print("Path #5: Speak with APOLO")
    time.sleep(a)
    print()
    secondPath = input("Which path will you choose? (1/2/3/4):")
    if secondPath == "2":
        path2_2()
    elif secondPath == "3":
        path1_1()
    ...
    time.sleep(a)
    print("The old woma call out to you.")
    time.sleep(a)
    print()
    s8 = 'Hello there, young traverler..'
    for character in s8:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s9 = ".. My name is MANDAL. I\'m in great need of help"
    for character in s9:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s10 = "... I konw who you seek... CHORNOS is just beyond this door..."
    for character in s10:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    time.sleep(a)
    print("Path #2: Honpr the wwoman's request. Help MANDAL return home safely..")
    time.sleep(a)
...
def path3_1():
    print()
    print("You begin walkinig toward the doors, ignoring MORALE's request.")
    time.sleep(a)
    print("I would help you out but I\'m in a bit of a hurry, you understand.")
    time.sleep(a)
    print("You pull open the massive doors with all of your night and enter.")
    time.sleep(a)
    print("Standing now in the largest room, in front of the largest man you have ever seen .")
    time.sleep(a)
    print("The room is dark, but you can see the source of the thunderous voice which call out to you...")
    time.sleep(a)
    print()
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 ="... It appears you've tanken a fairly hard route..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s3 ="... Your vision is keen. You seen through the darkness and the light.."
    for character in s3:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s4 =".. However, there is still just one.."
    for character in s4:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s5 =".. One more thing is still just one..."
    for character in s5:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s6 = "...And learn you will...."
    for character in s6:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
...
def path3_2():
    print("You begin walking towards MORALE, honoring her request.")
    time.sleep(a)
    ...
    time.sleep(a)
    print()
    print("You kneel in front of MORALE, allowing her to climb easily onto your back..")
    time.sleep(a)
    print("Standing up, you make your way back to the vines wall to make your ascent..")
    time.sleep(a)
    print("Just as you grab the vines, the enormous red and black iron doors thrust open, slamming to a halt..")
    time.sleep(a)
    print("The largest man you have ever seen steps out and his thunderous voice call out to you..")
    time.sleep(a)
    print()
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 = ".. It appears you\'vee taken a very difficult route..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    for character in s4:
        ...
        time.sleep(b)
    print()
    s5 =".... You have learned everything needs before your own..."
    for character in s5:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s6 ="... So you may finally be free.."
    for character in s6:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    print()
    s7 ="... It's time to return.."
    for character in s7:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
